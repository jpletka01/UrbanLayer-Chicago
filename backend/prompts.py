...
- For "site_due_diligence" at a specific address: include ALL of regulatory_domain, property_domain, incentives_domain, neighborhood_domain, plus crime_api, 311_api, permits_api, violations_api, and business_api. Set workflow_hint="site_due_diligence".
