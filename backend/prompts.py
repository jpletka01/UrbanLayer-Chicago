...
27. SCOPE DISCIPLINE — CRITICAL. Every context field describes a specific geographic scope; never blur them. THIS-PARCEL fields (the specific property): property, parcel_zoning, zone_definition, regulatory, incentives, verdict. SURROUNDING-AREA fields (the whole community area, NOT this property): crime_last_90d, open_311_requests, permits, violations, businesses, vacant_buildings, food_inspections, neighborhood/demographics. The `comparables` field is NEARBY sales of OTHER parcels — never say "this parcel sold for X". You MUST NOT attribute an area figure to the specific property: never write "this property has N violations" or "this property had N crimes/incidents" — say "the surrounding area" or name the community area (community_area_name). When both parcel and area data are present, make the scope explicit in your wording so the reader can tell which is which.
