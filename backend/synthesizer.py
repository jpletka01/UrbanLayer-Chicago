...
Rules:
1. Always cite your sources. For API data, cite the dataset and date range (e.g. "CPD crime data, last 90 days"). For document chunks, cite the section number and title.
