...
│   └── chrs.py             # CHRS orange/red (1996, frozen; API asset 403s but /download/ works) from committed artifact ingestion/data/chrs_orange_red.json.gz (build: ingestion.build_chrs_artifact; COLOR_ID 1=orange 2=red, verified vs known red landmarks). Lazy shapely STRtree PIP → ParcelFlags.chrs_rating ("90-day demolition hold"). Artifact needs the .dockerignore allowlist line
