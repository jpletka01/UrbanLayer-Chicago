...
const CARDS = [
  {
    ...
    caption: "Parcel data, 5-year assessment history, sales records, and tax estimates from Cook County.",
    content: (
      <div className="space-y-3 text-xs">
        <div className="grid grid-cols-2 gap-x-4 gap-y-2">
          <div>
            <div className="text-text-muted uppercase tracking-wider text-[10px]">PIN</div>
            <div className="font-mono text-text-primary">14-33-423-048-0000</div>
          </div>
          <div>
            <div className="text-text-muted uppercase tracking-wider text-[10px]">Class</div>
            <div className="text-text-primary">2-11 Two-Story Residence</div>
          </div>
          <div>
            <div className="text-text-muted uppercase tracking-wider text-[10px]">Building</div>
            <div className="text-text-primary">2,450 sq ft &middot; 2 stories</div>
          </div>
          <div>
            <div className="text-text-muted uppercase tracking-wider text-[10px]">Lot</div>
            <div className="text-text-primary">3,125 sq ft</div>
          </div>
        </div>
        <div className="border-t border-dark-border pt-2 space-y-1.5">
          <div className="text-text-muted uppercase tracking-wider text-[10px]">Assessment History</div>
        ...
        <div className="border-t border-dark-border pt-2 flex justify-between items-center">
          <span className="text-text-muted uppercase tracking-wider text-[10px]">Est. Annual Tax</span>
  ...
  },
  {
    ...
    caption: "12 overlay layers checked per address — landmarks to flood zones to ADU eligibility.",
    content: (
      <div className="space-y-3 text-xs">
        <div>
          <div className="text-text-muted uppercase tracking-wider text-[10px] mb-2">Zoning</div>
        ...
        <div className="border-t border-dark-border pt-2">
          <div className="text-text-muted uppercase tracking-wider text-[10px] mb-2">Active Overlays</div>
          <div className="flex flex-wrap gap-1.5">
            {[
              { label: "Planned Development", color: "bg-blue-500/15 text-blue-400" },
              { label: "Pedestrian Street", color: "bg-purple-500/15 text-purple-400" },
              { label: "TOD Eligible", color: "bg-emerald-500/15 text-emerald-400" },
        ...
        <div className="border-t border-dark-border pt-2">
          <div className="text-text-muted uppercase tracking-wider text-[10px] mb-2">Risk Factors</div>
  ...
  },
  {
    ...
    caption: "Demographics, transit access, and walkability scores assembled for every query.",
    content: (
      <div className="space-y-3 text-xs">
        <div>
          <div className="text-text-muted uppercase tracking-wider text-[10px] mb-2">Walkability</div>
          <div className="space-y-1.5">
            {[
              { label: "Walk Score", value: 92, color: "bg-emerald-500" },
              { label: "Transit Score", value: 87, color: "bg-blue-500" },
              { label: "Bike Score", value: 82, color: "bg-cyan-500" },
            ].map((s) => (
        ...
        <div className="border-t border-dark-border pt-2">
          <div className="text-text-muted uppercase tracking-wider text-[10px] mb-2">Nearest Transit</div>
        ...
        <div className="border-t border-dark-border pt-2">
          <div className="text-text-muted uppercase tracking-wider text-[10px] mb-2">Demographics</div>
          <div className="grid grid-cols-2 gap-x-4 gap-y-1.5">
            ...
            <div className="flex justify-between">
              <span className="text-text-muted">Med. Income</span>
              <span className="text-text-primary font-mono">$71,400</span>
            </div>
            <div className="flex justify-between">
              <span className="text-text-muted">Owner-Occ.</span>
              <span className="text-text-primary font-mono">42%</span>
            </div>
            <div className="flex justify-between">
              <span className="text-text-muted">Med. Age</span>
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-semibold text-text-primary tracking-tight">
            Ask one question. Get the full picture.
          </h2>
          <p className="text-sm md:text-base text-text-secondary max-w-lg mx-auto leading-relaxed">
            Here's what UrbanLayer returns when you ask about a single Chicago address.
          </p>
        </motion.div>
