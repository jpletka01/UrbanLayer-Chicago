...
| Persistence | SQLite via aiosqlite (WAL), schema v8 | Single user, single writer — simplest correct solution |
| i18n | Synthesizer-level translation + react-i18next | Backend stays English; synthesizer outputs in target language. Spanish shipped. |
