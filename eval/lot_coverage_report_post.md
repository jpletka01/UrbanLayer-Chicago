...
_2026-07-02 22:36Z · 100 panel addresses · 0 fetch errors_
...
| `comparables` | 10% of 48 | 44% of 18 | 100% of 2 | 9% of 11 | 0% of 21 |

## Addresses With Persistent Critical Gaps

| Address | Class | Group | Missing critical fields |
|---|---|---|---|
| 3101 W Touhy Ave | EX | exempt | `bldg_sqft`, `year_built`, `zoning_far` |
| 7101 S South Chicago Ave | EX | exempt | `bldg_sqft`, `year_built`, `zoning_far` |
| 7115 S South Chicago Ave | EX | exempt | `bldg_sqft`, `year_built`, `zoning_far` |
| 12200 S Hoxie Ave | 580 | commercial | `bldg_sqft`, `year_built`, `zoning_far` |
| 7117 S South Chicago Ave | EX | exempt | `bldg_sqft`, `year_built`, `zoning_far` |
| 623 W Madison St | 597 | commercial | `year_built`, `zoning_far` |
| 625 W Madison St | 597 | commercial | `year_built`, `zoning_far` |
| 2250 E 130Th St | 587 | commercial | `year_built`, `zoning_far` |
...
| 1514 W 33Rd St | 531 | commercial | `year_built`, `zoning_far` |
| 1555 N State Pkwy | EX | exempt | `bldg_sqft`, `year_built` |
| 1401 W 19Th St | EX | exempt | `bldg_sqft`, `year_built` |
| 1 S Halsted St | 529 | commercial | `year_built`, `zoning_far` |
| 11901 S Ashland Ave | EX | exempt | `bldg_sqft`, `year_built` |
| 4700 N Marine Dr | 591 | commercial | `year_built`, `zoning_far` |
| 9633 S Cottage Grove Ave | 397 | multifamily | `year_built`, `zoning_far` |
| 2240 E 130Th St | 593 | commercial | `year_built`, `zoning_far` |
